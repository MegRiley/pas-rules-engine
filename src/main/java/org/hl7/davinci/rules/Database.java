...
public class Database {
  ...
  public enum Table {
    ...
    RULES("Rules"), AUDIT("Audit"), CLIENT("Client");
  ...
  private Database(String relativePath) {
  ...
  public Bundle search(Table table, Map<String, Object> constraintMap) {
    // logger.info("Database::search(" + table.value() + ", " +
  ...
  public IBaseResource read(Table table, Map<String, Object> constraintParams) {
    // logger.info("Database::read(" + table.value() + ", " +
  ...
  public List<IBaseResource> readAll(Table table, Map<String, Object> constraintParams) {
    // logger.info("Database::readAll(" + table.value() + ", " +
  ...
  public boolean update(Table table, Map<String, Object> constraintParams, Map<String, Object> data) {
    // logger.info("Database::update(" + table.value() + ", WHERE " +
    // constraintParams.toString() + ", SET"
    // + data.toString() + ")");
  ...
  private PreparedStatement generateStatement(String sql, Collection<Map<String, Object>> maps, Connection connection)
    ...
    if (numValues != numValuesNeeded) {
      // logger.warning(
      // "Database::generateStatement:Value mismatch. Need " + numValuesNeeded + "
  ...
  public boolean delete(Table table, String id, String patient) {
    ...
    //// new Audit(AuditEventType.ACTIVITY, AuditEventAction.D, auditOutcome, null,
    //// null,
  ...
  public boolean delete(Table table) {
    ...
    // ////new Audit(AuditEventType.ACTIVITY, AuditEventAction.D, auditOutcome,
    // null, null, "Delete " + table.value());
    return result;
  }
